...
namespace Sport
{
    ...
    public class frmRVEingabe : frmForm//System.Windows.Forms.Form
    {
        ...
        private double _pos1 = 0.0;
        private double _pos2 = 0.0;
        private double _pos3 = 0.0;
        private double _pos4 = 0.0;
        private double _pos5 = 0.0;
        private double _pos6 = 0.0;
        private double _pos7 = 0.0;
        ...
        private void frmRVEingabe_Load(object sender, System.EventArgs e)
        {
            ...
            {
                var data = _rv.RvDaten[_rv.RvDaten.Count - 1];
        ...
        private void ShowText(Label label, string text1, string text2)
        {
            if (text2 == "")
                label.Visible = false;
            else
        ...
        private void EnableControl(bool visible, object obj1, object obj2, object obj3, object obj4)
        {
            if (obj1 is Label)
        ...
        private void OnLeaveStrecke(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                ShowText(lbZwischenOrt1, "Zeit-", _rv.SdDaten[found].ZwischenOrt1);
                ShowText(lbZwischenOrt2, "Zeit-", _rv.SdDaten[found].ZwischenOrt2);
                ShowText(lbZwischenOrt3, "Zeit-", _rv.SdDaten[found].ZwischenOrt3);
                ShowText(lbZwischenOrt4, "Zeit-", _rv.SdDaten[found].ZwischenOrt4);
                ShowText(lbZwischenOrt5, "Zeit-", _rv.SdDaten[found].ZwischenOrt5);
                ShowText(lbZwischenOrt6, "Zeit-", _rv.SdDaten[found].ZwischenOrt6);
                ShowText(lbZwischenOrt7, "Zeit-", _rv.SdDaten[found].ZwischenOrt7);

                lbMessposition1.Text = _rv.SdDaten[found].ZwischenOrt1;
                lbMessposition2.Text = _rv.SdDaten[found].ZwischenOrt2;
                lbMessposition3.Text = _rv.SdDaten[found].ZwischenOrt3;
                lbMessposition4.Text = _rv.SdDaten[found].ZwischenOrt4;
                lbMessposition5.Text = _rv.SdDaten[found].ZwischenOrt5;
                lbMessposition6.Text = _rv.SdDaten[found].ZwischenOrt6;
                lbMessposition7.Text = _rv.SdDaten[found].ZwischenOrt7;

                _pos1 = _rv.SdDaten[found].ZwischenDistanz1;
                _pos2 = _rv.SdDaten[found].ZwischenDistanz2;
                _pos3 = _rv.SdDaten[found].ZwischenDistanz3;
                _pos4 = _rv.SdDaten[found].ZwischenDistanz4;
                _pos5 = _rv.SdDaten[found].ZwischenDistanz5;
                _pos6 = _rv.SdDaten[found].ZwischenDistanz6;
                _pos7 = _rv.SdDaten[found].ZwischenDistanz7;

                if (_rv.SdDaten[found].Anzeige == 1) lbMessPos1.Visible = true;
                if (_rv.SdDaten[found].Anzeige == 2) lbMessPos2.Visible = true;
                if (_rv.SdDaten[found].Anzeige == 3) lbMessPos3.Visible = true;
                if (_rv.SdDaten[found].Anzeige == 4) lbMessPos4.Visible = true;
                if (_rv.SdDaten[found].Anzeige == 5) lbMessPos5.Visible = true;
                if (_rv.SdDaten[found].Anzeige == 6) lbMessPos6.Visible = true;
                if (_rv.SdDaten[found].Anzeige == 7) lbMessPos7.Visible = true;
            }
        ...
        private string KMh(TextBox tb, double km)
        {
            var tmp = tb.Text;
        ...
        private void cmdOk_Click(object sender, System.EventArgs e)
        {
            ...
            var data2 = _rv.RvDaten[_rv.RvDaten.Count - 1];
        ...
        private void OnEnterKommentar(object sender, System.EventArgs e)
        {
            ...
            var wert = 0.0;
            var zeilen = f.ReadWholeFile(Settings.DataDirectory + "total.dat");
            for (; ; )
            {
