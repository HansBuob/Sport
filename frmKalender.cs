...
namespace Sport
{
	...
	/// </summary>
	public class frmKalender : frmForm//: System.Windows.Forms.Form
	{
...
//			Font font=new Font("Verdana", 8);
			...
			if(_Jahr==0)
				_Jahr=f.ConvertToInt(Settings._Jahr);
			...
			for(var i=0;i<366;i++)
			{
				...
				if(info.Length!=0)
					e.Graphics.DrawString(info, font, new SolidBrush(Color.Black),vx*150-150+25,vy*12+12+2);
